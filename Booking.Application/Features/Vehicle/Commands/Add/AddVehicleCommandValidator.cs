...
{
     internal class AddVehicleCommandValidator :AbstractValidator<AddVehicleCommand>
     {
          public AddVehicleCommandValidator()
          {
               RuleFor(x => x.SeatNumber)
                    .NotNull().WithMessage("The number of seats  is required")
                    .NotEmpty().WithMessage("The number of seats cannot be empty");
